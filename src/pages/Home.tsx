...
const Home = () => {
  ...
  const technicalSkills = [
    ...
    },
    {
      icon: SiNuxtdotjs,
      text: 'NuxtJs',
      outline: 'outline-[#2D465B] dark:outline-[#3EB27F]',
    ...
    },
    {
      icon: FaGithubSquare,
      text: 'Github',
      outline: 'outline-[#000] dark:outline-[#fff]',
