...
const DownloadCv = () => {
  ...
  return (
    <Link
      ...
      className='flex mx-auto text-darkblue dark:text-ghostwhite ring-2 ring-deepskyblue transition-colors hover:ring-ghostwhite hover:text-white hover:bg-deepskyblue rounded-full mt-3 items-center justify-center gap-2 py-2 px-3 w-fit'
      target='_blank'
    >
